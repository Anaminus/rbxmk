...
[cmp-imperative]: https://github.com/Anaminus/rbxmk/compare/v0.9.0...imperative

## v0.9.0
**Highlights:**
- Add support for `.luau` extension.
	- Add [`luau` format](https://github.com/Anaminus/rbxmk/blob/v0.9.0/doc/formats.md#user-content-luau).
	- Add [`client.luau` format](https://github.com/Anaminus/rbxmk/blob/v0.9.0/doc/formats.md#user-content-clientluau).
	- Add [`localscript.luau` format](https://github.com/Anaminus/rbxmk/blob/v0.9.0/doc/formats.md#user-content-localscriptluau).
	- Add [`modulescript.luau` format](https://github.com/Anaminus/rbxmk/blob/v0.9.0/doc/formats.md#user-content-modulescriptluau).
	- Add [`script.luau` format](https://github.com/Anaminus/rbxmk/blob/v0.9.0/doc/formats.md#user-content-scriptluau).
	- Add [`server.luau` format](https://github.com/Anaminus/rbxmk/blob/v0.9.0/doc/formats.md#user-content-serverluau).
...
- Add support for Optional types.
	...
	- Add [types.none](https://github.com/Anaminus/rbxmk/blob/v0.9.0/doc/libraries.md#user-content-typesnone) to create an empty Optional exprim.
	- Add [types.some](https://github.com/Anaminus/rbxmk/blob/v0.9.0/doc/libraries.md#user-content-typessome) to create an Optional exprim that contains a value.
	- Currently, this only affects the "Model.WorldPivotData" property, which is an optional CFrame.
- Add support for [UniqueId](https://github.com/Anaminus/rbxmk/blob/v0.9.0/doc/types.md#user-content-uniqueid) type.
- Improve interface of the doc command.
	- Frag mode is the default. List mode is enabled with the `--list` flag.
- Add [RootDesc.Copy](https://github.com/Anaminus/rbxmk/blob/v0.9.0/doc/types.md#user-content-rootdesccopy) method.
...
- Fix options not working for the [rbx formats](https://github.com/Anaminus/rbxmk/blob/v0.9.0/doc/formats.md#user-content-rbxl).
- Fix [SetAttribute](https://github.com/Anaminus/rbxmk/blob/v0.9.0/doc/types.md#user-content-instancesetattribute) throwing an error when setting an attribute to nil.
- Fix [SetAttributes](https://github.com/Anaminus/rbxmk/blob/v0.9.0/doc/types.md#user-content-instancesetattributes) pulling wrong argument for dictionary.
- Fix nondeterministic order of encoded SharedStrings in [rbxl format](https://github.com/Anaminus/rbxmk/blob/v0.9.0/doc/formats.md#user-content-rbxl).
...
See a [comparison with the previous version][cmp-v0.9.0] for a thorough list of changes.

The [Documentation page][doc-v0.9.0] provides a complete reference for this version of rbxmk.

[doc-v0.9.0]: https://github.com/Anaminus/rbxmk/blob/v0.9.0/doc/README.md#user-content-rbxmk-reference
[cmp-v0.9.0]: https://github.com/Anaminus/rbxmk/compare/v0.8.0...v0.9.0

...
T.Pass(function() model.WorldPivotData = types.none("CFrame") end, "set to none")
...
T.Pass(function() model.WorldPivotData = types.some(CFrame.new(1,2,3)) end, "set to some")
...
T.Pass(function() model.WorldPivotData = types.none("CFrame") end, "with desc, set to none CFrame")
...
T.Fail(function() model.WorldPivotData = types.none("string") end, "with desc, set to none string")

T.Pass(function() model.WorldPivotData = types.some(CFrame.new(1,2,3)) end, "with desc, set to some CFrame")

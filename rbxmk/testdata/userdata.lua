...
T.Pass("userdata cache length is 2", T.UserDataCacheLen() == 2)
...
game = nil
T.GC()
T.Pass("userdata cache length is 1", T.UserDataCacheLen() == 1)
...
set = nil
T.GC()
T.Pass("userdata cache length is 0", T.UserDataCacheLen() == 0)

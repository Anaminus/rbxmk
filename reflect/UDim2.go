...
func UDim2() rbxmk.Reflector {
	return rbxmk.Reflector{
		Name:     T_UDim2,
		PushTo:   rbxmk.PushTypeTo(T_UDim2),
		PullFrom: rbxmk.PullTypeFrom(T_UDim2),
		...
		Metatable: rbxmk.Metatable{
			"__tostring": func(s rbxmk.State) int {
				v := s.Pull(1, T_UDim2).(types.UDim2)
				s.L.Push(lua.LString(v.String()))
				return 1
			},
			"__eq": func(s rbxmk.State) int {
				v := s.Pull(1, T_UDim2).(types.UDim2)
				op := s.Pull(2, T_UDim2).(types.UDim2)
		...
		Methods: rbxmk.Methods{
			"Lerp": {
				Func: func(s rbxmk.State, v types.Value) int {
					goal := s.Pull(2, T_UDim2).(types.UDim2)
				...
				Dump: func() dump.Function {
					return dump.Function{
						Parameters: dump.Parameters{
							{Name: "goal", Type: dt.Prim(T_UDim2)},
							{Name: "alpha", Type: dt.Prim(T_Float)},
						},
						Returns: dump.Parameters{
							{Type: dt.Prim(T_UDim2)},
						},
		...
		Constructors: rbxmk.Constructors{
			"new": {
				Func: func(s rbxmk.State) int {
					...
					switch s.Count() {
					case 2:
						v.X = s.Pull(1, T_UDim).(types.UDim)
						v.Y = s.Pull(2, T_UDim).(types.UDim)
					case 4:
						v.X.Scale = float32(s.Pull(1, T_Float).(types.Float))
						v.X.Offset = int32(s.Pull(2, T_Int).(types.Int))
						v.Y.Scale = float32(s.Pull(3, T_Float).(types.Float))
						v.Y.Offset = int32(s.Pull(4, T_Int).(types.Int))
					default:
				...
				Dump: func() dump.MultiFunction {
					return dump.MultiFunction{
						{
							Parameters: dump.Parameters{
								{Name: "xScale", Type: dt.Prim(T_Float)},
								{Name: "xOffset", Type: dt.Prim(T_Int)},
								{Name: "yScale", Type: dt.Prim(T_Float)},
								{Name: "yOffset", Type: dt.Prim(T_Int)},
							},
							Returns: dump.Parameters{
								{Type: dt.Prim(T_UDim2)},
							},
						...
						{
							Parameters: dump.Parameters{
								{Name: "x", Type: dt.Prim(T_UDim)},
								{Name: "y", Type: dt.Prim(T_UDim)},
							},
							Returns: dump.Parameters{
								{Type: dt.Prim(T_UDim2)},
							},
			...
			"fromScale": {
				Func: func(s rbxmk.State) int {
					return s.Push(types.UDim2{
						X: types.UDim{Scale: float32(s.Pull(1, T_Float).(types.Float))},
						Y: types.UDim{Scale: float32(s.Pull(2, T_Float).(types.Float))},
					})
				},
				Dump: func() dump.MultiFunction {
					return dump.MultiFunction{
			...
			"fromOffset": {
				Func: func(s rbxmk.State) int {
					return s.Push(types.UDim2{
						X: types.UDim{Offset: int32(s.Pull(1, T_Int).(types.Int))},
						Y: types.UDim{Offset: int32(s.Pull(2, T_Int).(types.Int))},
					})
				},
				Dump: func() dump.MultiFunction {
					return dump.MultiFunction{
		...
		Dump: func() dump.TypeDef {
			return dump.TypeDef{
				Operators: &dump.Operators{
					...
					Add: []dump.Binop{
						{
							Operand:     dt.Prim(T_UDim2),
							Result:      dt.Prim(T_UDim2),
